...
namespace NAWT.Data.Model
{
    ...
    public partial class NAWTEntities : DbContext
    {
        public NAWTEntities()
            : base("name=NAWTEntities")
        {
        }
        ...
        [DbFunction("NAWTEntities", "ProductsUnderThisUnitPrice")]
        public virtual IQueryable<ProductsUnderThisUnitPrice_Result> ProductsUnderThisUnitPrice(Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ProductsUnderThisUnitPrice_Result>("[NAWTEntities].[ProductsUnderThisUnitPrice](@price)", priceParameter);
        }
